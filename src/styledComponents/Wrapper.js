...
const StyledWrapper = styled.div`
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #cfe7fa), color-stop(100, #456687));

  /* Webkit (Chrome 11+) */ 
  background-image: -webkit-linear-gradient(top, #cfe7fa 0%, #456687 100%);

  /* W3C Markup */ 
  background-image: linear-gradient(to bottom, #cfe7fa 0%, #456687 100%);
  display: grid;
